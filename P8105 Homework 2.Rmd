...
The Combined Trash Wheel data set is made up of the Mr. Trash Wheel, Professor Trash Wheel, and Gwynnda Trash Wheel data sets. It consists of `r nrow(Combined_TrashWheel_df)` rows and `r ncol(Combined_TrashWheel_df)` columns. The total weight of the trash that was collected by Professor Trash Wheel was ____ tons. And the total weight of the trash that was collected by Professor Trash Wheel was ___ tons. 
