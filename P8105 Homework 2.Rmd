...
The total weight of the trash that was collected by Professor Trash Wheel was `r subset(Combined_TrashWheel_df, trash_wheel_name = "Professor Trash Wheel") |> pull(weight_tons) |> sum()` tons. And the total number of the cigarette butts that was collected by Gwynnda Trash Wheel was . 
...
The proportion of women in the study who are APOE4 carriers are `r nrow(baseline_carrier)`.
